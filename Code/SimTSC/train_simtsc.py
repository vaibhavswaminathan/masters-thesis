...
if __name__ == "__main__":
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    out_path = os.path.join(out_dir, args.dataset+'_'+str(args.seed)+'.txt')
    ...
    with open(out_path, 'w') as f:
        ...
        if args.dataset in multivariate_datasets:
            ...
            X, y, train_idx, test_idx = read_dataset_from_npy(os.path.join(data_dir, 'ebc_'+str(args.shot)+'_shot', args.dataset+'.npy'))
