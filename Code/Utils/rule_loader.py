...
# # Define a SPARQL query to retrieve all subjects
# query_string = """
# SELECT ?subject
...
def get_stmt_triples(graph, subject):
    results = graph.query(
        """
...
root_subject = "bldg:stmt2"
# root_subject = "http://example.com/mybuilding#stmt2"
get_stmt_triples(g, root_subject)